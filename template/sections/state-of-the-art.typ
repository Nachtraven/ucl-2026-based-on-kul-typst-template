...
With the goal of reconstructing tumor vascularization for the analysis of the antiangionetic drug Panopanib in the context of cancer treatment, we begin with histology for drug sreening, followed by the MicroCT methods used, and finish with an exploration of the methods of structure extraction from images.
