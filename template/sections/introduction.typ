...
briefly SOTA 3D histology for drug screening, the need for 3D histo is clear for companies developping drugs, I focus on antiangionetic drugs on tumor -> refer to Lisa thesis (effect of panopanib)
...
~
Blood vessel understanding and reconstruction has emerged over the past years as a critical element in understanding and pushing the boundaries in new drug research: angiogenesis, or the creation of new blood vessels, is a key step in the growth and spread of cancerous tumors. Classical methods, relevant for qualitative understanding and estimation, fall short in terms of accuracy for quantitative analysis for clinical trials [Source on angiogenesis in tumors]. The 2D reconstruction: its variability and lack of resolution being a limiting factor, the field is progressing towards the use of high resolution 3D data for these quantitative analysis tasks.
~ 
We will begin by diving into the current state of the art in 3D histology for drug sreening, followed by the MicroCT methods used, and finish with an exploration of the methods of image understanding more broadly, 

== SOTA Histology for drug screening 

=== SOTA Vascularization reconstruction


== SOTA 3D imaging using MicroCT


== SOTA of 3D reconstruction
